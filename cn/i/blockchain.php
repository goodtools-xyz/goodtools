...
?>
    ...
    <div class="check-box">
        ...
        <span><input type="checkbox" name="check-box" id="check-box" onclick="hiddentip()">隐藏工具提示
    </div>
    ...
    <div class="tool-box">
        ...
        <div id="myTabContent" class="tab-content">
            <div id="tab1" class="tab-pane active">
                ...
                <ul class="tab">
                    <li>
                        <a href="http://www.tuoniaox.com/"><span class="tool-name">鸵鸟区块链</span></a>
                <p class="tool-introduction ">24H不间断，最及时的区块链海内外资讯</p>
                </li>
                <li>
                    <a href="http://www.jinse.com"><span class="tool-name">金色财经</span></a>
                    <p class="tool-introduction ">7*24H区块链比特币资讯</p>
                </li>
                <li>
                    <a href="https://new.qq.com/tag/276813"><span class="tool-name">腾讯新闻·区块链</span></a>
                    <p class="tool-introduction ">腾讯新闻科技频道下专属区块链新闻信息</p>
                </li>
                <li>
                    <a href="http://chainb.com/"><span class="tool-name">铅笔</span></a>
                    <p class="tool-introduction ">ChainB,探讨数字货币和数字金融对于未来经济的重大影响</p>
                </li>
                <li>
                    <a href="http://www.8btc.com/"><span class="tool-name">巴比特</span></a>
                ...
                <ul class="tab">
                    <li>
                        <a href="http://www.coindesk.com"><span class="tool-name">Coindesk</span></a>
                        <p class="tool-introduction ">国外区块链资讯第一网站</p>
                    </li>
                    <li>
                        <a href="https://thebitcoinnews.com/"><span class="tool-name ">Bitcoin News</span></a>
        ...
        <div class="tab-content">
            ...
            <div id="knowledge" class="tab-pane active" role="tabpanel">
                ...
                <ul class="tab">
                    ...
                    <li>
                        <a href="https://bitcoin.org/zh_CN/"><span class="tool-name ">比特币入门指南</span></a>
