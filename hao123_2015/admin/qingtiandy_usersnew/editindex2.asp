...
<%
	...
	sql="Select Uid,Sum(Ujifen) from qingtiandy_jifen_ip Where "&kSql_where&" group by uid order by 2 desc"
...
<table width="98%" border="0" cellspacing="1" cellpadding="1"  align=center class="tableBorder">
	...
	<tr> 
	  ...
	  [<a href="editindex2.asp?a=0">今日积分</a>]
	  [<a href="editindex2.asp?a=1">昨日积分</a>]	
	  [<a href="editindex2.asp?a=2">近2天</a>]
	  [<a href="editindex2.asp?a=3">近3天</a>]
	  [<a href="editindex2.asp?a=4">近4天</a>]
	  [<a href="editindex2.asp?a=5">近5天</a>]
	  [<a href="editindex2.asp?a=6">近6天</a>]
	  [<a href="editindex2.asp?a=7">近7天</a>]
	  [<a href="editindex2.asp?a=14">近两周</a>] 
	   [<a href="editindex2.asp?a=30">近一个月</a>] 	      	    
	  </td>
	</tr>		
	</form>
</table>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
	...
	<tr>
		<td colspan="2"> 
			...
			<TR height=25>			
				<TD width="32%"   class=bodytitle><font color="#CC3300"><b>用户ID </b></font></TD>
				<TD width="61%"    class=bodytitle><font color="#CC3300"><b>积分</b></font></TD>
