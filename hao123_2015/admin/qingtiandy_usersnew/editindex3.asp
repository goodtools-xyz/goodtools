...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
	...
	<tr>
		<td colspan="2"> 
			...
			<TR height=25>			
				<TD width="29%"   class=bodytitle><font color="#CC3300"><b><%=G_jifen_jifen_name%>活动名称 </b></font></TD>
				<TD width="28%"    class=bodytitle><font color="#CC3300"><b>ip</b></font></TD>
			    <TD width="22%"    class=bodytitle><font color="#CC3300"><b>时间</b></font></TD>
			    <TD width="13%"    class=bodytitle><font color="#CC3300"><b><%=G_jifen_jifen_name%></b></font></TD>
		      <TD width="8%"   align="center" class=bodytitle><font color="#CC3300"><b>用户ID</b></font></td>
			</TR>					
			<%
