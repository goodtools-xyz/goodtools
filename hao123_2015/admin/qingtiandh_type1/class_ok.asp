...
<FORM name=FORM1 onSubmit="return FORM1_onsubmit()" action=class_ok.asp?action=add_class_1_ok method=post> 
  <TABLE width=100% border="0" align="center" cellPadding=3 cellSpacing=1 class="tableBorder"> 
    ...
    <TR> 
      <TD width=22% height=25 class="forumRowHighlight" align=right><b>类别所在的模版路径：</b></TD> 
      <TD width=78% height=25 class="forumRowHighlight"><INPUT maxLength=200 size=25 name=class_url>  请把模版放在 /template/<%=G_moban%>/<%=G_moban_html%>/下
</TD> 
    </TR>	
    <TR> 
      <TD width=22% height=25 class="forumRowHighlight" align=right><b>类别超级连接地址名字：</b></TD> 
      <TD width=78% height=25 class="forumRowHighlight"><INPUT maxLength=200 size=25 name=typehttpurl>  比如：game、movie等，留空则自动拼音命名
</TD> 
    </TR>
    <tr> 
    ...
    <TR> 
      ...
      <TD width=78% height=25 class="forumRowHighlight"><input name="typeno" size="25" value="100"/>（只能填数字：数字越小，显示越前面）</TD> 
    </TR> 
    <TR> 
...
<form name=FORM1 action="class_ok.asp?action=savedit_1" method=post onSubmit="return FORM1_onsubmit()"> 
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableBorder"> 
    ...
    <TR> 
      <TD width=22% height=25 class="forumRowHighlight" align=right><b>改类别所在的模版路径：</b></TD> 
      <TD width=78% height=25 class="forumRowHighlight"><INPUT maxLength=200 size=40 name=class_url value="<%=rs("typeurl")%>">  请把模版放在 /template/<%=G_moban%>/<%=G_moban_html%>/下
</TD> 
    </TR>
    <TR> 
      <TD width=22% height=25 class="forumRowHighlight" align=right><b>类别超级连接地址名字：</b></TD> 
      <TD width=78% height=25 class="forumRowHighlight"><INPUT maxLength=200 size=25 name=typehttpurl value="<%=rs("typehttpurl")%>">  比如：game、movie等，留空则自动拼音命名
</TD> 
    </TR>	
    <tr> 
      <td width="23%" class="forumRowHighlight" align=right><b>该类别外部http地址：</b></td> 
...
response.write"<TR>"
response.write"<TH class=tableHeaderText colSpan=2 height=25>导航类别管理</TH>"
