	...
	If isPostBack And Request.Form("editInfo")="editInfo" Then
		...
		For ai=0 To Ubound(all_str_a)
			...
			IF sm_name<>"" And sm_url<>"" And Instr(sm_url,"http://")>0 Then
				...
				oRs_ps.open "Select * from "&GG_Table&" where m_name = '"& sm_name &"' And m_type1="&sm_type1&" And m_type2="&sm_type2&" And m_type3="&sm_type3,conn,1,3
				IF oRs_ps.Eof Then
					oRs_ps.AddNew()
					oRs_ps("m_type1")			= sm_type1
					oRs_ps("m_type2")			= sm_type2
					oRs_ps("m_type3")			= sm_type3
...
<TABLE width="100%" border="0" align=center cellpadding="0" cellspacing="1" class="tableBorder"> 
	...
	<TR> 
		<TD align="left" class="Forumrow" ><b>网站一级类别： <font color="#FF0000">*</font></b></TD> 
		<TD class="Forumrow">			 
	...
	<TR>
		<TD align="left" class="Forumrow" ><b>网站三级类别： <font color="#FF0000">*</font></b></TD> 
		<TD class="Forumrow">			 
			<div id="div_m_type3">			 
