var G_All_moshi="{qt:G_All_moshi}"
var G_Newqt_Dir="{G_VIRTUAL_ROOT_DIR}"
var G_Newqt_countimg=document.createElement('img');
var G_Newqt_countimg2=document.createElement('img');
var G_Newqt_G_WebUrl="{qt:G_WEBURL}"
var G_Newqt_G_WEBNAME="{qt:G_WEBNAME}"
var G_Newqt_G_All_dhList_f="{qt:G_All_dhList_f}"
var G_Newqt_G_lm_baidu="{qt:G_lm_baidu}"
var G_Newqt_G_lm_baidu_ch="{qt:G_lm_baidu_ch}"
var G_Newqt_G_lm_google_s="{qt:G_lm_google_s}"
var G_Newqt_G_lm_sogou_s="{qt:G_lm_sogou_s}"
var G_Newqt_G_lm_taobao2="{qt:G_lm_taobao2}"
var G_Newqt_G_lm_xunlei="{qt:G_lm_xunlei}"
var G_Newqt_G_lm_dangdang_s="{qt:G_lm_dangdang_s}"
var G_Newqt_G_lm_amazon_s="{qt:G_lm_amazon_s}"
var G_Newqt_G_moban="{qt:G_moban}"
var G_Newqt_G_lm_360buy="{qt:G_lm_360buy}"
var G_Newqt_G_u_Cookies="{qt:G_u_Cookies}"
