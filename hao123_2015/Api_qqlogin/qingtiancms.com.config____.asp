...
Class QqConnet
    ...
    Private Sub Class_Initialize      
        QQ_OAUTH_CONSUMER_KEY = QQ_OAUTH_CONSUMER_KEY'APP ID
        QQ_OAUTH_CONSUMER_SECRET = QQ_OAUTH_CONSUMER_SECRET'APP KEY
        QQ_CALLBACK_URL = QQ_CALLBACK_URL'REDIRECT_URI
