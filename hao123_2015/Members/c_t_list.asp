...
<title>我的分类列表 - 用户中心 - <%=G_WEBNAME%></title>
</head>
<body>
...
<div class="wrap">
	...
	<div class="main-content">
		<div class="leftbar">
			...
			<div class="pv10">
				<div class="title">
					<h3 class="font-14 fl">我的分类列表</h3>
					<div class="hr"></div>
				</div>
				<div class="handle p10 gray">
					<a href="./c_t_add.asp">添加新分类</a>
				</div>
				<table class="sitetable select-all-none">
					...
					%>
						<tr>
							...
							<td>
								<a href="./c_t_add.asp?id=<%=oid%>">修改</a> - 
								<a href="./regok.asp?id=<%=oid%>&action=c_t_del" onclick="return confirm('确认删除吗？');">删除</a>
							</td>
						</tr>								
					<%	
						oRs2.MoveNext
