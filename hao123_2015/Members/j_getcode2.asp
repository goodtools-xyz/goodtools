...
<title>下线推荐 - 用户中心 - <%=G_WEBNAME%></title>
</head>
<body>
...
<div class="wrap">
	...
	<div class="main-content">
		<div class="leftbar">
			...
			<div class="pv10">
				<div class="title">
					<h3 class="font-14 fl">下线用户推广代码</h3>
					<div class="hr"></div>
				</div>
				<div class="handle p10 red">
					当下线用户获取积分的同时上线用户可以获取一定比例的<%=G_jifen_jifen_name%><br />
				</div>				
				<table width="100%" border="0" cellpadding="3" cellspacing="0" bordercolor="#C2DAEF"  >
				<tr>
				  <td><strong>推广连接：</strong><input NAME="codetxt0" ROWS="1" size="70" value="<%=G_WEBURL%><%=IIf(G_VIRTUAL_ROOT_DIR="","",G_VIRTUAL_ROOT_DIR&"/")%>qtUnion/c.asp?q=<%=zsoojs_id%>" id="codetxt0"> <a href="javascript:copycode(document.getElementById('codetxt0').value)">复制</a><br>
