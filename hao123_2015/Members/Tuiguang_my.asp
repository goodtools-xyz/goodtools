...
<title>我的推广 - 用户中心 - <%=G_WEBNAME%></title>
</head>
<body>
...
<div class="wrap">
	...
	<div class="main-content">
		<div class="leftbar">
			...
			<div class="pv10">
				<div class="title">
					<h3 class="font-14 fl">我的推广</h3>
					<div class="hr"></div>
				</div>		
				<table class="sitetable select-all-none">
					<tr><th width="21%">推广用户名</th>
						<th width="13%">是否有效</th>
						<th width="10%">任务数</th>
						<th width="14%"><%=G_jifen_jifen_name%>总数</th>
						<th width="21%">推广时间</th>
					...
					Sql="Select * From soojs_un where soojs_u_xiaxian='"&Request.Cookies(G_u_Cookies)("soojs_id")&"' "
					...
					%>
						<tr>
							<td><%=osoojs_u_name%></td>
							<td><%=osoojs_u_tuiguang_txt%></td>
							<td><%=oAll_1%></td>
							<td><%=osoojs_jifen%></td>
							<td><%=osoojs_date%></td>
							<td><%=osoojs_lastdate%></td>
						</tr>								
					<%	
							NN=NN+1
							Rs.MoveNext
					...
					End IF
					%>	
					<tr><td colspan="6"><%=PageInfo%> <%=Pager%></td></tr>
				</table>
			</div>
		</div>
