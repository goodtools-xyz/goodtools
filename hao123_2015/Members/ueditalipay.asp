...
<title>修改支付宝 - 用户中心 - <%=G_WEBNAME%></title>
</head>
<body>
<%
p=Request("p")
		...
		<div class="leftbar">
			<div class="pv10">
				...
				<table cellpadding="0" cellspacing="0" border="0" class="edit-form">
					...
					<tr>
						<th> </th>
						<td><input type="hidden" name="action" value="editalipay"><input type="submit" class="button btn-blue" value="确认" /> <input type="button" class="button btn-gray" value="返回" onclick="window.location='./'"  /></td>
						<td>&nbsp;</td>
					</tr>
				</table>
				</form>
